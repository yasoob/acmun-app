...
.factory('General', function() {
  ...
  // Some fake testing data
  var general = [
    { id: 0, name: 'Disarmament And International Security Committee'},
    { id: 1, name: 'Social, Humanitarian and Cultural Committee'},
    { id: 2, name: 'Special Political And Decolonization Committee'},
  ];
...
.factory('Specialised', function() {
  ...
  // Some fake testing data
  var specialised = [
    { id: 0, name: 'United Nations Security Council'},
    { id: 1, name: 'Historical Security Council'},
  ];
...
.factory('Economic', function() {
  ...
  // Some fake testing data
  var economic = [
    { id: 0, name: 'United Nations Human Rights Council'},
    { id: 1, name: 'United Nations Development Program'},
  ];
...
.factory('Independent', function() {
  ...
  // Some fake testing data
  var independent = [
    { id: 0, name: 'International Atomic Energy Agency'},
    { id: 1, name: 'Futuristic International Criminal Court'},
    { id: 2, name: 'Pakistan National Assembly'},
